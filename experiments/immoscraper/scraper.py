...
for seite in range(226, 5000):
    ...
    try:
        ...
        soup = bs.BeautifulSoup(
            urllib.request.urlopen("https://www.immobilienscout24.de/Suche/S-2/P-" + str(seite) + "/Haus-Kauf").read(),
            'lxml')
        ...
        df.to_csv(os.path.join(PATH, "/rohdaten/") + str(datetime.now())[:19].replace(":", "").replace(".", "") + ".csv", sep=";",
