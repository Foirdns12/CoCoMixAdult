...
df = pd.ExcelFile("C:/Users/phili/Desktop/MA/Datensatz/immoeinfamsueddeutsch.xlsx").parse(0)
...
df = df.drop(columns=["obj_regio1","obj_buildingType","obj_purchasePrice","obj_picturecount","obj_telekomUploadSpeed","ga_cd_via","obj_courtage","obj_telekomUploadSpeed","obj_zipCode","obj_telekomDownloadSpeed","obj_telekomInternet","obj_numberOfFloors","obj_lastRefurbish"])
...
categorical_features = ["obj_heatingType","obj_newlyConst","obj_firingTypes","obj_cellar","geo_krs","obj_condition","obj_interiorQual","obj_barrierFree","obj_rented","obj_regio3"]
