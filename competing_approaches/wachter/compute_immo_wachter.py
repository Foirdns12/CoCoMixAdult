...
if __name__ == "__main__":
    ...
    for i in range(3):
        result, foilset = calculate_foils(configuration,mad,df_test,model,transition_matrices,distance_matrices,df_train,n=60,factset=None,randomstate=rand,metrics=True)
